...
const BLOG = {
      ...
      NOTION_PAGE_ID:
            process.env.NOTION_PAGE_ID || '02a6d7fcd6174f23a5150097c01f0850',
      ...
      GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '没啥说的！',
    
      CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。
    
      AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '求生之路', // 您的昵称 例如 tangly1024
      BIO: process.env.NEXT_PUBLIC_BIO || 'coding', // 作者简介
      LINK: process.env.NEXT_PUBLIC_LINK || 'https://noteht.com', // 网站地址
      KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, unreal, game,技术分享', // 网站关键词 英文逗号隔开
    
      // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
      CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'terrellhu514@gmail.com', // 邮箱地址 例如mail@tangly1024.com
      CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
      CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
      CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/terrellhu', // 你的github个人主页 例如 https://github.com/tangly1024
      ...
      ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-NC1CZZ2X0K', // 谷歌Analytics的id e.g: G-XXXXXXXXXX

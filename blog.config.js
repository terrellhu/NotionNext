...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '226170b0196c4df291feeba76f117662',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '最全的S酷全书',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'skqs', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '成人文学爱好者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://skqsapp.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '成人小说,色酷全书,S酷全书', // 网站关键词 英文逗号隔开
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-XRDBC80G9H', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
